...
import 'package:fluttergram/modules/authentication/models/models.dart';
  ...
  group('LoginCubit', () {
    ...
    group('logInWithGoogle', () {
      blocTest<LoginCubit, LoginState>(
        ...
        verify: (_) {
          return verify(() => authenticationRepository.logInWithGoogle()).called(1);
        },
      );
        ...
        build: () {
          when(
            () => authenticationRepository.logInWithGoogle(),
              ...
              null, Invocation.getter(Symbol.empty)));
          return LoginCubit(authenticationRepository);
        },
        act: (cubit) => cubit.logInWithGoogle(),
        expect: () => const <LoginState>[
